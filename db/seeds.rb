...
times = [5, 15, 30, 60]
20.times do
  Todo.create(name: Faker::Hipster.sentence(word_count = 4), notes: Faker::Lorem.paragraph, time_est: times.sample, completed: false, user_id: 1+ rand(2), brainjuice_id: 1 + rand(3))
end
